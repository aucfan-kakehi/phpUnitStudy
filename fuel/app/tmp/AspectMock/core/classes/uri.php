...
class Uri
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($segment, $default), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($url, $secure), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($start), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($uri, $variables, $get_variables, $secure), true)) !== __AM_CONTINUE__) return $__am_res; 
		$url = '';
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($include_index), true)) !== __AM_CONTINUE__) return $__am_res; 
		$url = \Config::get('base_url');
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($vars, $uri, $secure), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($uri), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (\Fuel::$profiling)
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($segment, $default), false)) !== __AM_CONTINUE__) return $__am_res; 
