...
class Form_Instance
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($fieldset, $config), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($key, $default), false)) !== __AM_CONTINUE__) return $__am_res; 
		$attributes = $this->get_config('form_attributes', array());
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($attributes, $hidden), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($attributes, $legend), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($field, $value, $attributes), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($field))
		{
			$attributes = $field;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($field, $value, $checked, $attributes), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($field))
		{
			$attributes = $field;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($field, $attributes), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($field))
		{
			$attributes = $field;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($field, $values, $options, $attributes), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($field))
		{
			$attributes = $field;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($label, $id, $attributes), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($label))
		{
			$attributes = $label;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($attr), false)) !== __AM_CONTINUE__) return $__am_res; 
		unset($attr['label']);
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($field), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($config, $value), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($action), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $label, $attributes, $rules), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($class, $instance, $method), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $flatten), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($input, $repopulate), false)) !== __AM_CONTINUE__) return $__am_res; 
