...
class Response
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($body, $status, $headers), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($url, $method, $code), true)) !== __AM_CONTINUE__) return $__am_res; 
		$response = new static;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($body, $status, $headers), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($status), false)) !== __AM_CONTINUE__) return $__am_res; 
		$this->status = $status;
		return $this;
	}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $value, $replace), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($replace)
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($headers, $replace), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($send_headers), false)) !== __AM_CONTINUE__) return $__am_res; 
