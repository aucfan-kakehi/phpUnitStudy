...
class Str
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($string, $limit, $continuation, $is_html), true)) !== __AM_CONTINUE__) return $__am_res; 
		$offset = 0;
		$tags = array();
		if ($is_html)
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($str, $first, $separator), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($str, $start, $ignore_case), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($str, $end, $ignore_case), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($str, $start, $length, $encoding), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($str, $encoding), true)) !== __AM_CONTINUE__) return $__am_res; 
		$encoding or $encoding = \Fuel::$encoding;
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($type, $length), true)) !== __AM_CONTINUE__) return $__am_res; 
		switch($type)
		{
			case 'basic':
				return mt_rand();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($string, $array), true)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_string($string))
		{
			$tr_arr = array();
