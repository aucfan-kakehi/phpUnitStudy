...
class Fieldset
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($instance), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ($instance !== null)
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($instance), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($tag), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($fieldset), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $label, $attributes, $rules, $fieldname), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $flatten, $tabular_form), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($name === null)
		{
			$fields = $this->fields;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($model, $relation, $parent, $blanks), false)) !== __AM_CONTINUE__) return $__am_res; 
